...
export default function Home({ onSelect }: Props) {
  return (
    <div className="animate-fade-in-up">
      <Header 
        title="OrdinaryTools" 
        subtitle="The ultimate media toolkit for YouTube and Instagram."
        icon="⚡"
      />
      ...
      <div className="container">
        <div className="tool-grid">
          <div className="tool-card glass-card" onClick={() => onSelect('youtube')}>
            <div className="tool-card__icon youtube">📺</div>
          ...
          <div className="tool-card glass-card" onClick={() => onSelect('instagram')}>
            <div className="tool-card__icon instagram">📸</div>
      ...
      <style>{`
        ...
        .tool-card__icon.instagram {
          text-shadow: 0 0 20px rgba(225, 48, 108, 0.4);
        }
      `}</style>
    </div>
  );
